...
from YukkiMusic.plugins.playlist import del_plist_msg
from YukkiMusic.plugins.sudoers import sudoers_list
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            return await message.reply_photo(
                       ...
                       caption=_["help_1"].format(config.SUPPORT_CHANNEL), reply_markup=keyboard
            )
        if name[0:4] == "song":
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/InflexSupport) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
